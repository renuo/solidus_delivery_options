module SolidusDeliveryOptions
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_javascripts
        append_file 'vendor/assets/javascripts/spree/frontend/all.js', "//= require spree/frontend/solidus_delivery_options\n"
        append_file 'vendor/assets/javascripts/spree/backend/all.js', "//= require spree/backend/solidus_delivery_options\n"
      end
      ...
      def add_migrations
        run 'bundle exec rake railties:install:migrations FROM=solidus_delivery_options'
      end
